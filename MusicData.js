...
//         (Song3 name) by (Song3 Artist Name),
    getInfo(){
        ...
        console.log(`${this.song1.title} by ${this.song1.artist.name}`);
        console.log(`${this.song2.title} by ${this.song2.artist.name}`);
        console.log(`${this.song3.title} by ${this.song3.artist.name}`);
    }
}
